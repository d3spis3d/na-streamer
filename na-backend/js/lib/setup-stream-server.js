...
export default function(streamers, tracks, filesByStreamer, clients, nextSongInQueue) {
    ...
    streamerServer.on('connection', setupServerConnectionHandler(tracks, filesByStreamer, writeToAllClients, addToStreamers, nextSongInQueue));
